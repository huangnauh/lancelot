...
var (
	...
	ErrSlaveOfInsideMulti   = RedisNew("SlaveOf inside MULTI is not allowed")
	...
	ErrStartConflictsWithPrefix = RedisNew("start conflicts with prefix")
	ErrEndConflictsWithPrefix   = RedisNew("end conflicts with prefix")
