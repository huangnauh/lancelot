...
sleep 2
./runtest --host 127.0.0.1 --port 6379 --single unit/type/hash --tags "$TAGS" --ignore-encoding  || exit 1
sleep 2
./runtest --host 127.0.0.1 --port 6379 --single unit/type/set --tags "$TAGS" --ignore-encoding  || exit 1
sleep 2
./runtest --host 127.0.0.1 --port 6379 --single unit/type/zset --tags "$TAGS" --ignore-encoding  || exit 1
sleep 2
./runtest --host 127.0.0.1 --port 6379 --single unit/type/list --tags "$TAGS" --ignore-encoding  || exit 1
sleep 2
./runtest --host 127.0.0.1 --port 6379 --single unit/type/list-2 --tags "$TAGS" --ignore-encoding  || exit 1
sleep 2
./runtest --host 127.0.0.1 --port 6379 --single unit/type/list-3 --tags "$TAGS" --ignore-encoding  || exit 1
sleep 2
