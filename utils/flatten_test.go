...
var flattentests = []flattenTest{
	...
	{FlattenB{A: FlattenA{A: "a", B: 1, C: 2, D: 3.0, E: true, F: time.Second}, B: map[string]FlattenA{"c": {A: "c", B: 1, C: 2, D: 3.0, E: true, F: time.Second}}},
		map[string]interface{}{"a.a": "a", "a.b": uint8(1), "a.c": int16(2), "a.d": float64(3.0), "a.e": true, "a.f": "1s", "b.c.a": "c", "b.c.b": uint8(1), "b.c.c": int16(2), "b.c.d": float64(3.0), "b.c.e": true, "b.c.f": "1s"}},
	{FlattenP{}, map[string]interface{}{}},
	{FlattenP{A: &FlattenA{A: "a", B: 1, C: 2, D: 3.0, E: true, F: time.Second}},
		map[string]interface{}{"a.a": "a", "a.b": uint8(1), "a.c": int16(2), "a.d": float64(3.0), "a.e": true, "a.f": "1s"}},
	{FlattenP{A: &FlattenA{A: "a", B: 1, C: 2, D: 3.0, E: true, F: time.Second}, B: map[string]*FlattenA{"c": {A: "c", B: 1, C: 2, D: 3.0, E: true, F: time.Second}}},
		map[string]interface{}{"a.a": "a", "a.b": uint8(1), "a.c": int16(2), "a.d": float64(3.0), "a.e": true, "a.f": "1s", "b.c.a": "c", "b.c.b": uint8(1), "b.c.c": int16(2), "b.c.d": float64(3.0), "b.c.e": true, "b.c.f": "1s"}},
	{&FlattenA{}, map[string]interface{}{"c": int16(0), "d": float64(0), "e": false}},
	{&FlattenA{A: "a", B: 1, C: 2, D: 3.0, E: true, F: time.Second},
		map[string]interface{}{"a": "a", "b": uint8(1), "c": int16(2), "d": float64(3.0), "e": true, "f": "1s"}},
