...
func NewCommand(red *redcon.Server) *Command {
	...
	c.TxnHandle = map[string]TxnHandler{
		...
		JSONMGET_COMMAND: {
			Name:     JSONMGET_COMMAND,
			Func:     c.JsonMgetHandle,
			ID:       163,
			Typo:     JsonType,
			ReadOnly: true,
		},
		JSONOBJKEYS_COMMAND: {
			Name:     JSONOBJKEYS_COMMAND,
			Func:     c.JsonObjKeysHandle,
			ID:       164,
			Typo:     JsonType,
			ReadOnly: true,
		},
		JSONOBJLEN_COMMAND: {
			Name:     JSONOBJLEN_COMMAND,
			Func:     c.JsonObjLenHandle,
			ID:       165,
			Typo:     JsonType,
			ReadOnly: true,
		},
		JSONARRLEN_COMMAND: {
			Name:     JSONARRLEN_COMMAND,
			Func:     c.JsonArrLenHandle,
			ID:       166,
			Typo:     JsonType,
			ReadOnly: true,
		},
